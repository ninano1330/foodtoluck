			...
			<!-- left logo -->
  			<div class="col-md-6">
  				<div class="left-margin top-margin">
    				<img src="resources/img/logo.JPG" style="width:150px" onclick="javascript:logo_click();"/>
    			</div>
  			</div>
...
<%-- 			var request_uri = "<%= request.getAttribute( "javax.servlet.forward.request_uri" )%>"; --%>
<%-- 			var queryString = "<%= request.getQueryString()%>"; --%>
			
// 			alert("queryString = " + queryString);
// 			if(queryString != "null"){
// 				request_uri = request_uri + "?" + queryString;
// 			}
